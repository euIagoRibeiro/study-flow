...
export const primaryButtonClass = `h-11 ${centered} rounded-md bg-marca-texto px-4 font-semibold text-sobre-marca hover:brightness-95 active:brightness-90 disabled:cursor-wait disabled:opacity-60 ${focusRing}`
